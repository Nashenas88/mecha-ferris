...
A hexapod mech suit for Ferris.
...
- probe-rs. Upstream support for RP2040 was added with version 0.3.1.

- A CMSIS-DAP probe. (J-Link and other probes will not work with probe-rs)
...
# If you want to use elf2uf2-rs instead of probe-rs, instead do...
...
See the [open issues](https://github.com/nashenas88/mecha-ferris/issues) for a list of
...
6. Create a [New Pull Request](https://github.com/nashenas88/mecha-ferris/pulls)
