...
import com.mechaferris.mechaferris.ui.calibrating.CalibratingView
import com.mechaferris.mechaferris.ui.controls.ControlsView
import com.mechaferris.mechaferris.ui.home.HomeView
...
class Connected : ComponentActivity() {
    ...
    private val batteryChangeNotifications = Channel<Int>()
    ...
    private val bodyTranslationChangeNotifications = Channel<Vector3>()
